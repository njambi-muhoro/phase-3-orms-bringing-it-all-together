class Dog
  ...
  # define a class method on Dog that will execute
  #  the correct SQL to create a dogs table.
  ...
  # create a new dog object and uses the
   #save method to save that dog to the database
